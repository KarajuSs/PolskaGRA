...
public class SupportMessageTemplatesFactory {
	...
	private void registerTemplates() {
		...
		addTemplate("$bugstracker","Cześć %s. Wygląda na to, że znalazłeś nowy błąd. Gdybyś mógł zostawić wiadomośc ze szczegółowym opisem jak do tego doszło na #http://www.polskagra.org/bugzilla to byłbym wdzięczny - bardzo dziękuję.");
		addTemplate("$faq", "Cześć. Odpowiedź na swoje pytanie znajdziesz w FAQ, który jest bardzo pomocny więc przeczytaj go uważnie! #http://www.polskagra.org/faq. Dziękujemy, że jesteś z nami!");
		addTemplate("$faqpvp","Witaj %s i przykro słyszeć o tym. Przeczytaj uważnie regulamin dostępny na http://www.polskagra.org/regulamin-gry-mmorpg - powodzenia w przyszłości.");
		...
		addTemplate("$notsupport","Cześć %s. Nie możemy pomóc Tobie w tym problemie. Skorzystaj z #http://www.polskagra.org/bugzilla.");
		addTemplate("$password","Witaj %s możesz zmienić hasło wysyłając e-mail z adresu podanego przy rejestracji konta na adres haslo@polskagra.org w tytule wpisując Zmiana hasła, a w treści podając nazwę postaci oraz nowe hasło.");
